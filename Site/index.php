...
<html>
  <head>
    ...
    <body class="container">
            ...
            <nav>
              ...
              if ($_SESSION["admin"]==0) {
                echo "
                  ...
                  aaa><li><li><a href='login.php'>Connexion</a></li><!aaaa
                  aaa>";
              }
      ...
      if ($_SESSION["admin"]==0) {
        echo "<p><h7>Bienvenue</p></h7>"."<h3><p>Ceci est une application informatique qui permet de superviser les machines de son réseau.</p>"."<p>
        Pour commencer à utiliser notre application, veuillez vous connecter.</p></h3>";
