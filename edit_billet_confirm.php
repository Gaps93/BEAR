                ...
                while ($ligne = $res->fetch())
                  {
                    ...
                    $heure='<p><h5> le '. date_format($date, 'd-m-Y').' à '. date_format($date, 'H:i') .'</h5></p>';

                  }

                  echo "
                    <form action='insertion_contenu.php?action=5' method='post'>
                      <p>
                        Titre : <input type='text' name='titre' value='$titre'/></p>
                        $heure
                        <p>Contenu : <input type='text' name='contenu' value='$contenu'/>
                        <input type='hidden' name='article' value='$article' /></p>
                        <p><input type='submit' value='Modifier'/>
                      </p>
                    </form><form action='administration.php' type='hidden' method='post'>
                      <p>
