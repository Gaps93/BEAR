...
<html>
  <head>
    ...
    <body class="container">
            ...
            <nav>
              ...
              if ($_SESSION["admin"]==0) {
                echo "
                  ...
                  aaa><li><a>Telechargement</a></li><li class='actif'><a href='login.php'>Connexion</a></li><!aaaa
                  aaa>";
              }
              ...
              elseif ($_SESSION["admin"]==1) {
                echo "
                  ...
                  aaa><li><a>Produit</a></li><!aaaa
                  aaa><li><a>Support</a></li><!aaaa
                  aaa><li><a>Telechargement</a></li><li class='actif'><a href='action.php?action=1'>Deconnexion</a></li><!aaaa
                  aaa>";
              }
                  ?>
              </ul>
      ...
      {
        echo "<h3><p>Erreur de Saisi, Recommencer.</h3></p>";
      }
